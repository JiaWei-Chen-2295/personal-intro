              ...
              <CardItem translateZ="40" className="w-full">
                <div className="flex flex-col sm:flex-row items-center gap-4 pt-6 w-full md:w-auto justify-end md:justify-start">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full sm:w-auto px-8 py-4 bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 text-white font-bold rounded-full transition-all hover:-translate-y-1 flex items-center justify-center gap-2 text-center"
                  >
                    查看 HTML 简历
